...
Benchmark the multi-turn chat. Referred from the code of 
...
def run_first_turn(llm=None, sampling_params=None, prompts=None):
...
def main(args):
    ...
    # (taeklim): Swap out the KV caches from GPU memory to different device.


    print("------Begin Second turn------")
    run_first_turn(
        llm=llm,
        prompts=prompts,
        sampling_params=sampling_params,
...
if __name__ == "__main__":
    parser = FlexibleArgumentParser(
        description=
        'Benchmark the performance of multi-turn chat with different swap device.')
